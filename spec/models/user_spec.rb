...
describe User do
  ...
  describe "creation and validation" do
    ...
    it "should reject duplicate email addresses" do
      ...
      User.create!(@attr)
      user_with_duplicate_email=User.new(@attr.merge(:name=>@attr[:name]+" 2"))
  ...
  describe "password encryption" do
    ...
    describe "authenticate method" do
      ...
      it "should return nil on email/password mismatch" do
        wrong_password_user = User.authenticate(@attr[:email], "wrongpass")[0]
        wrong_password_user.should be_nil
      end
      
      it "should return nil for an email address with no user" do
        nonexistent_user = User.authenticate("bar@foo.com", @attr[:password])[0]
        nonexistent_user.should be_nil
      end
      
      it "should return the user on email/password match" do
        matching_user = User.authenticate(@attr[:email], @attr[:password])[0]
  ...
  describe "relationships" do
    ...
    it "should fail unfollowing a not-followed user" do
      @user.should_not be_following(@followed)
      expect{ @user.unfollow!(@followed) }.to raise_error(NoMethodError)
    end
